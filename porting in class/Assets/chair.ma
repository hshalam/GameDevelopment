...
//Name: chair.ma
//Last modified: Thu, Jul 17, 2014 01:41:40 PM
//Codeset: UTF-8
requires maya "2014";
...
createNode transform -s -n "persp";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 33.251018729100011 15.431642161363291 25.792133949724853 ;
	setAttr ".r" -type "double3" -20.138352729595582 412.19999999996145 2.5946468249177343e-15 ;
...
createNode transform -n "pCube1";
	setAttr ".t" -type "double3" -0.34542638578048557 2.3246839709523934 1.1523491422648529 ;
...
createNode transform -n "pCube2";
	setAttr ".t" -type "double3" -5.4958106247326119 5.8243591034573976 1.0824155720348649 ;
	setAttr ".r" -type "double3" 0 0 -64.346626348272011 ;
	setAttr ".s" -type "double3" 1 9.9999999999999998e-13 1.0788812913919457 ;
...
createNode transform -n "pCylinder1";
	setAttr ".t" -type "double3" 3.1400441941849806 1.1587061510928225 -1.7209380262469565 ;
	setAttr ".s" -type "double3" 0.33637371267013266 1.3946620857110015 0.40496242296663448 ;
...
createNode transform -n "pCylinder2";
	setAttr ".t" -type "double3" -3.7392630009301664 1.1587061510928225 -1.9716430348368394 ;
	setAttr ".s" -type "double3" 0.33637371267013266 1.3946620857110015 0.40496242296663448 ;
...
createNode transform -n "pCylinder3";
	setAttr ".t" -type "double3" 2.9671052545432852 0.81276205919715716 4.1709562068736918 ;
	setAttr ".s" -type "double3" 0.33637371267013266 1.3946620857110015 0.40496242296663448 ;
...
createNode transform -n "pCylinder4";
	setAttr ".t" -type "double3" -4.3081850292871069 1.2313299377267124 4.3063370768917526 ;
	setAttr ".s" -type "double3" 0.33637371267013266 1.3946620857110015 0.40496242296663448 ;
...
createNode polyCube -n "polyCube1";
	setAttr ".w" 7.4765250056331389;
	setAttr ".h" 0.65683181465888263;
	setAttr ".d" 6.4296056141222557;
	setAttr ".cuv" 4;
createNode polyCube -n "polyCube2";
	setAttr ".w" 7.2064090036789921;
	setAttr ".d" 6.4647659454353708;
	setAttr ".cuv" 4;
